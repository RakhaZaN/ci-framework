									...
									<div class="col-6">
										<div class="d-flex align-items-center">
											<svg class="bi text-primary" width="32" height="32" fill="blue" style="width:10px">
												<use xlink:href="<?= base_url('public/assets/images/bootstrap-icons.svg#circle-fill"') ?> />
                                            </svg>
												...
												<td class="col-3">
													<div class="d-flex align-items-center">
														<div class="avatar avatar-md">
															<img src="<?= base_url('public/assets/images/faces/5.jpg') ?>">
														</div>
					...
					<div class="card-content pb-4">
						<div class="recent-message d-flex px-4 py-3">
							<div class="avatar avatar-lg">
								<img src="<?= base_url('public/assets/images/faces/4.jpg') ?>">
							</div>
							<div class="name ms-4">
